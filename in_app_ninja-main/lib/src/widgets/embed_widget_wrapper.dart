...
/// Extension method on [Widget] for easy inline target ID assignment
extension EmbedWidgetWrapperX on Widget {
  /// Wraps the widget in an [EmbedWidgetWrapper] with the given [id] for InAppNinja targeting
  Widget appNinjaIdentifier(String id) {
    return EmbedWidgetWrapper(id: id, child: this);
  }
}
