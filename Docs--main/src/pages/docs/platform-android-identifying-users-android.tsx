...
const SLUG = "/platform/android/identifying-users-android";
const TITLE = "Identifying Users";
const DESCRIPTION = "Configure identifying users for the Android SDK and keep the integration aligned with the rest of your EmbedCraft workspace.";
...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    "runs": [
      {
        "t": "t",
        "v": "Configure identifying users for the Android SDK and keep the integration aligned with the rest of your EmbedCraft workspace."
      }
    ]
  },
  {
