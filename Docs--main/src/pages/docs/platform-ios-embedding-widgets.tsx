...
const SLUG = "/platform/iOS/Embedding%20Widgets";
const TITLE = "iOS Embedding Widgets";
...
const BLOCKS: Block[] = [
  {
    "type": "heading",
    "level": 1,
    "text": "iOS Embedding Widgets",
    "id": "ios-embedding-widgets"
  },
  {
    "type": "p",
    "runs": [
      ...
      [
        {
          "t": "a",
          "v": "iOS Banners",
          "h": "/platform/iOS/Embedding%20Widgets/Banners"
        },
        {
          "t": "t",
      ...
      [
        {
          "t": "a",
          "v": "iOS Stories",
          "h": "/platform/iOS/Embedding%20Widgets/Stories"
        },
        {
          "t": "t",
          "v": " \u2014 open this internal documentation page."
