...
const SLUG = "/platform/android/Callbacks/uicallbacks";
const TITLE = "Android UI Callbacks";
const DESCRIPTION = "Configure android ui callbacks for the Android SDK and keep the integration aligned with the rest of your EmbedCraft workspace.";

const BLOCKS: Block[] = [
  {
    "type": "heading",
    "level": 1,
    "text": "Android UI Callbacks",
    "id": "android-ui-callbacks"
  },
  {
    "type": "p",
    "runs": [
      {
        "t": "t",
        "v": "Configure android ui callbacks for the Android SDK and keep the integration aligned with the rest of your EmbedCraft workspace."
      }
    ]
  },
  {
