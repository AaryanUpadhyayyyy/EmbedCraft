...
const SLUG = "/platform/iOS/Callbacks/corecallbacks";
const TITLE = "iOS Core Callbacks";
const DESCRIPTION = "Configure ios core callbacks for the iOS SDK and keep the integration aligned with the rest of your EmbedCraft workspace.";

const BLOCKS: Block[] = [
  {
    "type": "heading",
    "level": 1,
    "text": "iOS Core Callbacks",
    "id": "ios-core-callbacks"
  },
  {
    "type": "p",
    "runs": [
      {
        "t": "t",
        "v": "Configure ios core callbacks for the iOS SDK and keep the integration aligned with the rest of your EmbedCraft workspace."
      }
    ]
  },
  {
