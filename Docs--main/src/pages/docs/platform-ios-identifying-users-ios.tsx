...
const SLUG = "/platform/iOS/identifying-users-ios";
const TITLE = "Identifying Users";
const DESCRIPTION = "Configure identifying users for the iOS SDK and keep the integration aligned with the rest of your EmbedCraft workspace.";
...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    "runs": [
      {
        "t": "t",
        "v": "Configure identifying users for the iOS SDK and keep the integration aligned with the rest of your EmbedCraft workspace."
      }
    ]
  },
  {
