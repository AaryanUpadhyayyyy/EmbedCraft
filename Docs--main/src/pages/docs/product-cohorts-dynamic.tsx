...
const SLUG = "/product/Cohorts/dynamic";
const TITLE = "Dynamic Cohorts";
const DESCRIPTION = "Use dynamic cohorts to group users for campaigns, rewards, messages, and experiments.";
...
const BLOCKS: Block[] = [
  ...
  },
  {
    ...
    "runs": [
      {
        "t": "t",
        "v": "Use dynamic cohorts to group users for campaigns, rewards, messages, and experiments."
      }
    ]
  },
  {
