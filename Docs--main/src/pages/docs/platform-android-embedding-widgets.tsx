...
const SLUG = "/platform/android/Embedding%20Widgets";
const TITLE = "Android Embedding Widgets";
...
const BLOCKS: Block[] = [
  {
    "type": "heading",
    "level": 1,
    "text": "Android Embedding Widgets",
    "id": "android-embedding-widgets"
  },
  {
    "type": "p",
    "runs": [
      ...
      [
        {
          "t": "a",
          "v": "Android Banners",
          "h": "/platform/android/Embedding%20Widgets/Banners"
        },
        {
          "t": "t",
      ...
      [
        {
          "t": "a",
          "v": "Android Stories",
          "h": "/platform/android/Embedding%20Widgets/Stories"
        },
        {
          "t": "t",
          "v": " \u2014 open this internal documentation page."
